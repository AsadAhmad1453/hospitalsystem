    ...
    <section id="basic-datatable">
                        ...
                        <tbody>
                            @foreach($medicines as $medicine)
                                <tr class="text-center">
                                    ...
                                    <td>{{$medicine->name}}</td>
                                    <td>
                                        <a href="{{route('del-medic', $medicine->id)}}" data-jobs="sdadas" class="text-danger course-sure"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        <div class="modal modal-slide-in fade" id="modals-slide-in">
            <div class="modal-dialog sidebar-sm">
                <form action="{{route('save-medic')}}" id="form" method="POST" enctype="multipart/form-data" class="add-new-record modal-content pt-0">
                    @csrf
                    ...
                    <div class="modal-body flex-grow-1">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control dt-full-name @error('name') is-invalid @enderror" id="name" placeholder="Medicine"  />
                            @error('name')
...
<script>
    ...
    $(function () {
        ...
        if (dt_basic_table.length) {
            ...
            $('div.head-label').html('<h6 class="mb-0">Medicines</h6>');
        }
    });
    ...
    Swal.fire({
        icon: 'warning',
        title: 'Are you sure?',
        text: "You want to remove this Medicine!",
