...
<section id="basic-datatable">
                    ...
                    <tbody>
                        @foreach($permissions as $index => $permission)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('del-perm', $permission->id) }}" class="text-danger course-sure" data-jobs="sdadas"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
    ...
    <div class="modal modal-slide-in fade" id="modals-slide-in">
        <div class="modal-dialog sidebar-sm">
            <form action="{{route('save-permission')}}" method="POST" class="add-new-record modal-content pt-0">
                @csrf
