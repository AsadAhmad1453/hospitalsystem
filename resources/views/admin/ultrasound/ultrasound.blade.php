    ...
    <section id="basic-datatable">
        ...
        <div class="modal modal-slide-in fade" id="modals-slide-in">
            <div class="modal-dialog sidebar-sm">
                <form action="{{route('save-us')}}" id="form" method="POST" class="add-new-record modal-content pt-0">
                    @csrf
...
<script>
    ...
    $(function () {
        ...
        if (dt_basic_table.length) {
            ...
            $('div.head-label').html('<h6 class="mb-0">Ultrasounds</h6>');
        }
    });
    ...
    Swal.fire({
        icon: 'warning',
        title: 'Are you sure?',
        text: "You want to remove this Ultrasound!",
