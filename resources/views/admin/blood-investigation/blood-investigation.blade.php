    ...
    <section id="basic-datatable">
                        ...
                        <tbody>
                            @foreach($bloodInvestigations as $test)
                                <tr>
                                    ...
                                    <td>{{$test->name}}</td>
                                    <td>
                                        <a href="{{route('del-blood-inv', $test->id)}}" data-jobs="sdadas" class="text-danger course-sure"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        <div class="modal modal-slide-in fade" id="modals-slide-in">
            <div class="modal-dialog sidebar-sm">
                <form action="{{route('save-blood-inv')}}" id="form" method="POST" class="add-new-record modal-content pt-0">
                    @csrf
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">×</button>
                    <div class="modal-header mb-1">
                        <h5 class="modal-title" id="exampleModalLabel">New Blood Investigation</h5>
                    </div>
