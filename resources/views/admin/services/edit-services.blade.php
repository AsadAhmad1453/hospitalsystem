        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form" method="POST" action="{{ route('update-service') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="question">Service Name</label>
                                        <input type="text" id="service_name" class="form-control " placeholder="Service Name" name="service_name" value="{{$service->service_name}}" />
                                ...
                                <div class="col-md-12 mb-1">
                                    ...
                                    <textarea class="form-control" id="detail_description" name="detail_description" rows="6">{{ $service->detail_description }}</textarea>
