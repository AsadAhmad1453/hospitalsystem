                        ...
                        <tbody>
                            @foreach($sections as $section)
                                <tr>
                                    ...
                                    <td>{{$section->name}}</td>
                                    <td>
                                        <a href="{{route('del-section', $section->id)}}" data-jobs="sdadas" class="text-danger course-sure"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
...
$(function () {
        ...
        if (dt_basic_table.length) {
            ...
            $('div.head-label').html('<h6 class="mb-0">Sections</h6>');
        }
    });
