                    ...
                    <div class="card-body p-4">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                ...
                                <p class="text-muted mb-0">Order a new blood investigation test for a patient with complete
                                    details.</p>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control @error('test_name') is-invalid @enderror"
                                        id="test_name" name="test_name" placeholder="Enter test name" required>
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <div class="form-text">Include any relevant clinical information or special
                                        instructions.</div>
                                </div>
                    ...
                    success: function(response) {
                        ...
                        setTimeout(() => {
                            window.location.href =
                                '{{ route('admin-new.blood-investigation') }}';
                        }, 1500);
                    },
                    error: function(xhr) {
                        hideLoading(button, originalText);
                        if (xhr.responseJSON && xhr.responseJSON.errors) {
                            ...
                            showError('Error ordering test: ' + (xhr.responseJSON?.message ||
                                'Unknown error'));
                        }
                    }
                });
