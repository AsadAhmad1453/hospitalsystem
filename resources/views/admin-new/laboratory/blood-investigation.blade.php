                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Test name, patient..."
                                        id="searchInput">
                                </div>
                            </div>
                            <div class="col-md-2">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <small
                                                            class="text-muted">{{ $test->patient->phone ?? 'N/A' }}</small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                ...
                                                @if ($test->description)
                                                    <small
                                                        class="text-muted">{{ Str::limit($test->description, 30) }}</small>
                                                @endif
                                            </td>
                                            <td>
                                                <span
                                                    class="badge bg-info">{{ ucfirst($test->test_type ?? 'General') }}</span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        @if ($test->status !== 'completed')
                                                            <li><a class="dropdown-item" href="#"
                                                                    onclick="updateResults({{ $test->id }})">
                                                                    <i class="fas fa-flask me-2"></i>Update Results
                                                                </a></li>
                                                        @endif
                                                        <li><a class="dropdown-item" href="#"
                                                                onclick="printReport({{ $test->id }})">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="datetime-local" class="form-control" id="expected_date"
                                    name="expected_date">
                            </div>
                            <div class="col-md-6 mb-3">
...
@section('custom-js')
    <script>
        ...
        function deleteTest(testId) {
            confirmDelete('Are you sure you want to delete this blood test? This action cannot be undone.').then((
            result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('admin-new.del-blood-inv', ':id') }}".replace(':id', testId),
                        type: 'GET',
                        success: function(response) {
