                    ...
                    <div class="card-body d-flex align-items-center">
                        <div class="flex-grow-1">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="number h6" style="font-size: 20px !important;">{{ $medicines->count() }}
                                    </div>
                                    <div class="label" style="font-size: 12px !important;">&nbsp;Total Medicines</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body d-flex align-items-center">
                        <div class="flex-grow-1">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="number h6" style="font-size: 20px !important;">{{ $lowStockCount ?? 0 }}
                                    </div>
                                    <div class="label" style="font-size: 12px !important;">&nbsp;Low Stock</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body d-flex align-items-center">
                        <div class="flex-grow-1">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="number h6" style="font-size: 20px !important;">
                                        {{ $prescriptionsCount ?? 0 }}</div>
                                    <div class="label" style="font-size: 12px !important;">&nbsp;Prescriptions</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex-grow-1">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="label" style="font-size: 12px !important;">&nbsp;Total Value</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Name, generic name..."
                                        id="searchInput">
                                </div>
                            </div>
                            <div class="col-md-2">
                                ...
                                <tbody>
                                    @foreach ($medicines as $medicine)
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <small
                                                            class="text-muted">{{ $medicine->manufacturer ?? 'N/A' }}</small>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-info">{{ ucfirst($medicine->category ?? 'General') }}</span>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                            ...
                                            <td>
                                                <span
                                                    class="fw-bold text-primary">${{ number_format($medicine->price ?? 0, 2) }}</span>
                                            </td>
                                            <td>
                                                @if ($medicine->expiry_date)
                                                    <span
                                                        class="{{ \Carbon\Carbon::parse($medicine->expiry_date)->isPast() ? 'text-danger' : (\Carbon\Carbon::parse($medicine->expiry_date)->diffInDays() <= 30 ? 'text-warning' : 'text-success') }}">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li><a class="dropdown-item" href="#"
                                                                onclick="viewHistory({{ $medicine->id }})">
                                                                <i class="fas fa-history me-2"></i>Stock History
                                                            </a></li>
                                                        <li><a class="dropdown-item" href="#"
                                                                onclick="createPrescription({{ $medicine->id }})">
        ...
        function filterTable() {
            ...
            $('#medicinesTable tbody tr').each(function() {
                ...
                if (stock) {
                    ...
                    if (stock === 'in-stock' && (stockText.includes('out of stock') || stockText.includes(
                            'low stock'))) {
                        show = false;
