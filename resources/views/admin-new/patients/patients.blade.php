    ...
    <div class="container-fluid">
        ...
        <div class="row mb-4">
            @php
                $stats = [
                    [
                        'count' => $patients->where('patient_status', '1')->count(),
                        'label' => 'Active Patients',
                        'icon' => 'fas fa-user-injured',
                        'style' => '',
                    ],
                    [
                        'count' => $patients->where('patient_status', '0')->count(),
                        'label' => 'Discharged',
                        'icon' => 'fas fa-user-check',
                        'style' => 'background: linear-gradient(135deg, #28a745 0%, #20c997 100%);',
                    ],
                    [
                        'count' => $patients->where('created_at', '>=', now()->subDays(7))->count(),
                        'label' => 'This Week',
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Name, ID, or Phone..."
                                        id="searchInput">
                                </div>
                            </div>
                            <div class="col-md-2">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="fw-bold text-primary">
                                                    #{{ $patient->unique_number ?? $patient->id }}</div>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <small class="text-muted">{{ $patient->age ?? 'N/A' }} years
                                                            old</small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <div><i class="fas fa-phone me-1"></i> {{ $patient->phone ?? 'N/A' }}
                                                    </div>
                                                    <div><i class="fas fa-envelope me-1"></i>
                                                        {{ $patient->email ?? 'N/A' }}</div>
                                                </div>
                                            </td>
                                            <td>
                                                @if ($patient->doctor)
                                            ...
                                            <td>
                                               ...
                                               style="min-width: 40px;">
                                                <i class="fas fa-eye"></i>
                                                    ...
                                                    <div class="dropdown">
                                                        <button class="btn btn-sm btn-outline-primary p-2 dropdown-toggle"
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('admin-new.patient-full-report', $patient->id) }}">
    ...
    <script>
        ...
        function filterTable() {
            ...
            $('#patientsTable tbody tr').each(function() {
                ...
                if (status && !$(this).find('.badge').text().toLowerCase().includes(status === '1' ? 'active' :
                        'discharged')) {
                    show = false;
                }
