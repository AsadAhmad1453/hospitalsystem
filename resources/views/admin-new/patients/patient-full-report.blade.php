...
<div class="container-fluid">
                ...
                <div class="card-body p-4">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="text-muted mb-0">Comprehensive medical history and records for {{ $patient->name }}</p>
                        </div>
                        <div class="col-md-4 text-md-end">
                            <div class="btn-group">
                                ...
                                <a href="{{ route('admin-new.patients') }}" class="btn btn-outline-secondary">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-8">{{ ucfirst($patient->sex ?? $patient->gender ?? 'N/A') }}</div>
                                    </div>
                                    <div class="row mb-2">
                        ...
                        <div class="visit-section mb-4">
                            <div class="visit-header bg-light p-3 rounded mb-3">
                                <h6 class="mb-0">
                                    ...
                                    Visit #{{ $loop->iteration }} - {{ \Carbon\Carbon::parse($visitDate)->format('F j, Y') }}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 mb-2">
                                                <strong>Systolic BP:</strong> {{ $record->systolic_blood_pressure ?? 'N/A' }} mmHg
                                            </div>
                                            <div class="col-6 mb-2">
                                                <strong>Diastolic BP:</strong> {{ $record->diasystolic_blood_pressure ?? 'N/A' }} mmHg
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($test->results)
                                            <div class="text-muted small">{{ Str::limit($test->results, 50) }}</div>
                                        @else
    ...
    <!-- Imaging Studies -->
    @if((isset($xrays) && $xrays->count() > 0) || (isset($ultrasounds) && $ultrasounds->count() > 0) || (isset($ctscans) && $ctscans->count() > 0))
    <div class="row mb-4">
        <div class="col-12">
            <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $appointment->appointment_date ? \Carbon\Carbon::parse($appointment->appointment_date)->format('M j, Y \a\t h:i A') : 'N/A' }}</td>
                    ...
                    <div class="row text-center">
                        <div class="col-md-3">
                            <div class="border rounded p-3">
                                <h3 class="text-primary">{{ isset($groupedRecords) ? $groupedRecords->count() : 0 }}</h3>
                                <p class="mb-0">Total Visits</p>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="border rounded p-3">
                                <h3 class="text-success">{{ isset($bloodInvestigations) ? $bloodInvestigations->count() : 0 }}</h3>
                                <p class="mb-0">Blood Tests</p>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="border rounded p-3">
                                <h3 class="text-warning">{{ (isset($xrays) ? $xrays->count() : 0) + (isset($ultrasounds) ? $ultrasounds->count() : 0) + (isset($ctscans) ? $ctscans->count() : 0) }}</h3>
