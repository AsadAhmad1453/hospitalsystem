                ...
                <div class="card-body p-4">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            ...
                            <p class="text-muted mb-0">Create and manage form questions with various types and options.</p>
                        </div>
                ...
                <div class="card-body d-flex align-items-center">
                    <div class="flex-grow-1">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <div class="number">{{ $questions->where('question_type', 2)->count() }}</div>
                                <div class="label">Text Questions</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Question text..." id="searchInput">
                            </div>
                        </div>
                        <div class="col-md-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <div class="fw-bold">{{ Str::limit($question->question, 60) }}</div>
                                                @if($question->description)
                                                <small class="text-muted">{{ Str::limit($question->description, 40) }}</small>
                                                @endif
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="dropdown position-static">
                                            ...
                                            <ul class="dropdown-menu show-overflow-menu" style="position: absolute; z-index: 1050; min-width: 200px;">
                                                ...
                                                <li><a class="dropdown-item" href="#" onclick="manageOptions({{ $question->id }})">
                                                    <i class="fas fa-list me-2"></i>Manage Options
                                                </a></li>
                                                <li><a class="dropdown-item" href="#" onclick="duplicateQuestion({{ $question->id }})">
                                                    <i class="fas fa-copy me-2"></i>Duplicate
                                                </a></li>
                                                <li><hr class="dropdown-divider"></li>
                                                <li><a class="dropdown-item" href="#" onclick="moveUp({{ $question->id }})">
                                                    <i class="fas fa-arrow-up me-2"></i>Move Up
                                                </a></li>
                                                <li><a class="dropdown-item" href="#" onclick="moveDown({{ $question->id }})">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" id="validation_rules" name="validation_rules" placeholder="e.g., min:1,max:100">
                        </div>
                        <div class="col-md-3 mb-3">
...
function filterTable() {
    ...
    $('#questionsTable tbody tr').each(function() {
        ...
        if (type && !$(this).find('.badge').text().toLowerCase().includes(getTypeText(type).toLowerCase())) {
            show = false;
        }
