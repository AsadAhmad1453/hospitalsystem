        ...
        <div class="row mb-4">
            @php
                $stats = [
                    ...
                    [
                        'count' => '' . number_format($services->avg('amount') ?? 0),
                        'label' => ' Avg. Price',
                        'icon' => 'fas fa-rupee-sign',
                        'style' => 'background: linear-gradient(135deg, #28a745 0%, #20c997 100%);',
                    ],
                    [
                        'count' => $services->where('created_at', '>=', now()->subDays(30))->count(),
                        'label' => 'This Month',
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="#" data-filter="all">All Services</a>
                                            </li>
                                            <li><a class="dropdown-item" href="#"
                                                    data-filter="consultation">Consultation</a></li>
                                            <li><a class="dropdown-item" href="#"
                                                    data-filter="diagnostic">Diagnostic</a></li>
                                            <li><a class="dropdown-item" href="#"
                                                    data-filter="treatment">Treatment</a></li>
                                            <li><a class="dropdown-item" href="#"
                                                    data-filter="emergency">Emergency</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="position-relative">
                            @if ($service->image)
                                <img src="{{ asset($service->image) }}" class="card-img-top"
                                    alt="{{ $service->service_name }}" style="height: 200px; object-fit: cover;">
                            @else
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="h6 mb-0">Rs.{{ number_format($service->amount, 2) }}</span>
                                ...
                                <tbody>
                                    @foreach ($services as $service)
                                        <tr>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    @if ($service->image)
                                                        <img src="{{ asset($service->image) }}"
                                                            alt="{{ $service->service_name }}" class="rounded me-3"
                                            ...
                                            <td>
                                                <span
                                                    class="fw-bold text-primary">${{ number_format($service->amount, 2) }}</span>
                                            </td>
                                            <td>
    ...
    <div class="modal fade" id="addServiceModal" tabindex="-1">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form action="{{ route('admin-new.save-service') }}" method="POST" id="addServiceForm"
