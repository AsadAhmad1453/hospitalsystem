...
@section('content')
    <div class="data-table-page-hero">
        <div>
            <h2 class="text-white">Biomarker Queue</h2>
                        ...
                        <tbody>
                            @foreach ($rounds as $round)
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a href="{{ route('biomarker-add', $round->patient->id) }}" data-jobs="sdadas"
                                            class="btn btn-primary">Examine</a>
                                        <a href="{{ route('view-patient', $round->patient->id) }}" data-jobs="sdadas"
