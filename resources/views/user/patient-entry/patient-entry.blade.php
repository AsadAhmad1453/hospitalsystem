...
@section('content')
    <div class="data-table-page-hero">
        <div>
            <h2 class="text-white">Active Patients</h2>
                            ...
                            @foreach ($patients as $patient)
                                <tr class="text-center">
                                    ...
                                    <td class="text-center">
                                        ...
                                        @else
                                            <a href="{{ route('patient-invoice', $patient->id) }}"
                                                class="btn btn-danger make-payment">Make Payment</a>
                                        @endif
                                    </td>
                                    <td>
                                        <a href="{{ route('round-status-update', $patient->id) }}" data-jobs="sdadas"
